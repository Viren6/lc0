...
void SearchParams::Populate(OptionsParser* options) {
  ...
  options->Add<FloatOption>(kOptimismMaxEffectId, -200, 200) = 45;
  options->Add<FloatOption>(kOptimismSlopeId, -20, 20) = 5;
  options->Add<FloatOption>(kOptimismBiasId, -10, 10) = 1.4;
